...
export const ProductList =  ({ category,tenantSlug,narrowView }: Props) => {
    ...
    return (
        <><div className={cn("grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2x1:gri-cols-4 gap-4",narrowView && "lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3")}>
            {data?.pages
