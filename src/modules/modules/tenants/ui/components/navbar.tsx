...
// import { CheckoutButton } from "@/modules/modules/checkout/ui/components/checkout-button";
...
const CheckoutButton=dynamic(()=>import("@/modules/modules/checkout/ui/components/checkout-button").then(
